...
_PLACES = [
    ...
    # ── Kletterparks + Abenteuer ────────────────────────────
    {
        "source_id": "mountmitte",
        "title": "MountMitte Kletterpark",
        "description": "Kletterpark direkt am Hauptbahnhof! 4 Parcours in bis zu 14m Hoehe, "
                       "Seilbahn ueber die Spree. Leicht erreichbar, perfekt nach der Schule.",
        "location_name": "MountMitte",
        "address": "Caroline-Michaelis-Str. 8, 10115 Berlin",
        "lat": 52.5279, "lon": 13.3729,
        "tags": ["outdoor", "abenteuer", "sport"],
        "age_min": 6, "age_max": 99,
        "price_info": "ab 18 EUR",
        "is_permanent": 1,
    },
    {
        "source_id": "beelitz-kletterpark",
        "title": "Baumkronenpfad Beelitz-Heilstaetten",
        "description": "Spektakulaerer Pfad in 23m Hoehe ueber den Ruinen der verlassenen "
                       "Heilstaetten. Lost Place trifft Natur. Atemberaubend!",
        "location_name": "Baumkronenpfad Beelitz",
        "address": "Str. nach Fichtenwalde 13, 14547 Beelitz",
        "lat": 52.2580, "lon": 12.9285,
        "tags": ["outdoor", "abenteuer", "natur"],
        "age_min": 5, "age_max": 99,
        "price_info": "ab 11 EUR / Kind 7 EUR",
        "is_permanent": 1,
        "is_special": 1,
    },
    {
        "source_id": "jungfernheide-hochseil",
        "title": "BergWerk Jungfernheide (Indoor-Klettern)",
        "description": "Berlins groesster Indoor-Hochseilgarten. 4 Etagen, 200+ Kletterstationen, "
                       "auch bei Regen. Kinder ab 1.10m Koerpergroesse.",
        "location_name": "BergWerk Berlin",
        "address": "Heckerdamm 260, 13627 Berlin",
        "lat": 52.5456, "lon": 13.2870,
        "tags": ["indoor", "abenteuer", "sport"],
        "age_min": 6, "age_max": 99,
        "price_info": "ab 20 EUR",
        "is_permanent": 1,
    },
    {
        "source_id": "boulderklub",
        "title": "Boulderklub Berlin (Bouldern fuer Kinder)",
        "description": "Bouldern ohne Seil in Absprunghoehe. Kinder-Bereich, Kurse ab 6 Jahre. "
                       "Drei Standorte in Berlin. Super Einstieg ins Klettern.",
        "location_name": "Boulderklub Berlin",
        "address": "Ohlauer Str. 38, 10999 Berlin",
        "lat": 52.4933, "lon": 13.4283,
        "tags": ["indoor", "sport", "abenteuer"],
        "age_min": 5, "age_max": 99,
        "price_info": "ab 10 EUR / Kind",
        "is_permanent": 1,
    },
    # ── Wasser + Natur ────────────────────────────────────
    {
        "source_id": "strandbad-wannsee",
        "title": "Strandbad Wannsee",
        "description": "Europas laengstes Binnenseestrandbad. 1.3 km Sandstrand, Rutschen, "
                       "Sprungturm, Beachvolleyball. Saison Mai–September.",
        "location_name": "Strandbad Wannsee",
        "address": "Wannseebadweg 25, 14129 Berlin",
        "lat": 52.4311, "lon": 13.1781,
        "tags": ["outdoor", "wasser", "sport", "natur"],
        "age_min": 0, "age_max": 99,
        "price_info": "6 EUR / erm. 3.50 EUR",
        "is_permanent": 1,
    },
    {
        "source_id": "floss-bauen-spree",
        "title": "Floss bauen + Spree paddeln (Hauptstadtfloss)",
        "description": "Eigenes Floss bauen und damit die Spree runter paddeln! "
                       "3-4 Stunden, alles angeleitet. Unvergessliches Familienabenteuer.",
        "location_name": "Hauptstadtfloss",
        "address": "Zur alten Flussbadeanstalt 5, 10317 Berlin",
        "lat": 52.4874, "lon": 13.5048,
        "tags": ["outdoor", "wasser", "abenteuer", "handwerk"],
        "age_min": 6, "age_max": 99,
        "price_info": "ab 45 EUR / Person",
        "is_permanent": 1,
        "is_special": 1,
    },
    {
        "source_id": "kanu-mueggelspree",
        "title": "Kanu-Tour Mueggelspree",
        "description": "Kanutour durch die ruhige Mueggelspree. 2-4 Stunden, "
                       "Biber-Spuren, Eisvogel-Sichtungen. Kanus vor Ort mietbar.",
        "location_name": "Kanuverleih Mueggelspree",
        "address": "Mueggelseedamm 164, 12587 Berlin",
        "lat": 52.4397, "lon": 13.6472,
        "tags": ["outdoor", "wasser", "natur", "abenteuer"],
        "age_min": 5, "age_max": 99,
        "price_info": "ab 15 EUR / Kanu / Stunde",
        "is_permanent": 1,
        "is_special": 1,
    },
    # ── Aktiv + Sport ─────────────────────────────────────
    {
        "source_id": "jump-house",
        "title": "JUMP House Berlin",
        "description": "Trampolinpark mit 120+ Trampolinen, Ninja Parcours, Dodgeball, "
                       "Schaumstoff-Grube. 60/90 Min Sessions. Kinder drehen durch!",
        "location_name": "JUMP House",
        "address": "Miraustr. 38, 13509 Berlin",
        "lat": 52.5794, "lon": 13.3204,
        "tags": ["indoor", "sport", "spiel"],
        "age_min": 6, "age_max": 99,
        "price_info": "ab 16 EUR / 60 Min",
        "is_permanent": 1,
    },
    {
        "source_id": "go-kart-berlin",
        "title": "Kartbahn Berlin (Indoor Go-Kart)",
        "description": "Indoor-Kartbahn mit Elektro-Karts. Junior-Karts ab 8 Jahre, "
                       "130 cm Koerpergroesse. 10-Minuten-Rennen.",
        "location_name": "Kartbahn Berlin",
        "address": "Am Juliusturm 15, 13599 Berlin",
        "lat": 52.5389, "lon": 13.2092,
        "tags": ["indoor", "sport", "abenteuer"],
        "age_min": 8, "age_max": 99,
        "price_info": "ab 12 EUR / Rennen",
        "is_permanent": 1,
    },
    # ── Escape Rooms fuer Familien ────────────────────────
    {
        "source_id": "escape-room-kinder",
        "title": "Escape Room fuer Kinder (Exit Berlin)",
        "description": "Spezielle Kinder-Escape-Rooms: leichtere Raetsel, kindgerechte Themen "
                       "(Piraten, Zauberschule). Ab 8 Jahre mit Erwachsenen.",
        "location_name": "Exit Berlin",
        "address": "Klosterstr. 62, 10179 Berlin",
        "lat": 52.5154, "lon": 13.4098,
        "tags": ["indoor", "abenteuer", "spiel"],
        "age_min": 8, "age_max": 99,
        "price_info": "ab 20 EUR / Person",
        "is_permanent": 1,
    },
    {
